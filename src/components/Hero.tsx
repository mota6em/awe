const Hero = () => {
  return (
    <div className="flex flex-col ">
      <div className="bg-[#f1ebe6] py-10 pb-0 px-6 md:px-14 xl:px-32 flex flex-col md:flex-row justify-between items-center gap-4">
        <img
          src="./imgs/logo.png"
          alt="Logo image"
      ...
      <span className="h-10 bg-gradient-to-t from-black/10 to-[#f1ebe6] pointer-events-none"></span>
    </div>
  );
};
